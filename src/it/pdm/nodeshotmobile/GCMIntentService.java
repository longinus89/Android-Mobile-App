...
import com.google.android.gcm.demo.app.CommonUtilities;
...
public class GCMIntentService extends GCMBaseIntentService {
    ...
    protected void onRegistered(Context context, String registrationId) {
        ...
        CommonUtilities.displayMessage(context, "ID = "+registrationId);
     ...
     */
    private static void generateNotification(Context context, String message, String load) {
        ...
        notification.setLatestEventInfo(context, title, load, intent);
